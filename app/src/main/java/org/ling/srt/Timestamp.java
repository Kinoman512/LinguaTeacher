package org.ling.srt;

public class Timestamp {
	private int hours, minutes, seconds, milliseconds, all;
	...
	public Timestamp(String time) throws InvalidTimestampFormatException {
		...
		this.all = milliseconds + seconds* 1000 + minutes * 60 * 1000 + hours * 60 * 60 * 1000;
	}
