...
import odyssey.ru.linguateacher.PlayerActivity;
import odyssey.ru.linguateacher.R;
import odyssey.ru.linguateacher.Tag;
...
//    public IAction actionForChipClick;
    ...
    public MySnackBar(AppCompatActivity context, LayoutInflater inflater, View rootView) {
    ...
    public void showTranslatedWord(final View pbLoading, final SetWords currentSet, String selectedtext) {
        ...
        ys.setServerActionListnerTanslate(new IActionHandler() {
            ...
            public void onSuccessAction(Object rs) {
                ...
                //переделать
                PlayerActivity.activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
